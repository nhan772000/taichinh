...
@section('content')
	<body>
	@if($user->datelogin == $user->dategift)
	<div class="cookie-popup-wrap">
		<div class="cookie-popup">
			<h2>MÀN CHỜ NHẬN THƯỞNG</h2>
			<p>BẤM XÁC NHẬN ĐỂ NHẬN THƯỞNG NÀO</p>

			<h6 id="closepopup"><a href="{!!url('/tangqua')!!}" class="btn btn-success1 button_home">NHẬN THƯỞNG</a></h6>
		</div>
		<!--End .cookie-popup-->
	</div>
	@endif
