              ...
              <div class="panel-body">
                <div class="row">
                  <div class="col-xs-12 text-left">
                      ...
                      <!--Form tăng hạn mức-->
                        <form action="{!!url('/tanghanmuc')!!}" method="GET">
                           <div class="form-group">
                            <label for="muahangmuc">Bạn muốn mua bằng:</label>
                              <select class="form-control" name="muahangmuc">
                                <option name="otp_vichinh" value="otp_vichinh" >Ví chính</option>
                                <option name="otp_viphu" value="otp_viphu">Ví phụ</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="point" placeholder="point" value="5000">
                  ...
                  <div class="input-group form-group">
                    <input type="password" class="form-control" id="pwdtt" placeholder="Account password" name="pwdtt">
            ...
            <div id="collapse2" class="panel-collapse collapse">
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-xs-6">
                    <iframe width="100%" height="200" src="https://www.youtube.com/embed/tgbNymZ7vqY?playlist=tgbNymZ7vqY&loop=1">
                    </iframe>
                  </div>
