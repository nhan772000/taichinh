   ...
   public function acceptTransaction(Request $request){
    ...
    foreach ($arr_ids as $transaction_id){
        $transaction = Transaction::where('transaction_id', $transaction_id)->first();
            ...
            $walletmainController->create_notice($transaction_id, $transaction_id, $transaction->transaction_point, 0, 0);
            ...
            elseif($transaction->transaction_typeorder == 1){
                ...
                $walletmainController->create_notice($transaction->transaction_fromuser, $transaction->transaction_touser,$transaction->transaction_point * 9/10, 1, 0);
                $walletmainController->create_notice($transaction->transaction_fromuser, $transaction->transaction_touser,$transaction->transaction_point * 1/10, 1, 1);
