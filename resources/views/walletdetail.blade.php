        ...
        <div class="col">
            <div class="row">
                <div class="col kcol text-center uppercase">
                    ...
                    <div id="balance">
                        <div>
                          <span><input readonly value="{{$wallet_point}} POINT"/></span>
                          <span><i class="fa fa-exchange"></i></span>
                          <span><input readonly id="rate_VND" value="{{ SettingRateCurrency::where('id', 1)->value('rate_currency') * $wallet_point}} VND"/></span>
                          <span><i class="fa fa-exchange"></i></span>
                          <span><input readonly id="rate_USDT" value="{{ SettingRateCurrency::where('id', 2)->value('rate_currency') * $wallet_point}} USDT"/></span>
